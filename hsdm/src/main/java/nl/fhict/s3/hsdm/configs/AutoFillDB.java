...
public class AutoFillDB {
    ...
    CommandLineRunner commandLineRunner(ISpellCardRepository spellCardRepository, IHeroCardRepository heroCardRepository, IWeaponCardRepository weaponCardRepository, IMinionCardRepository minionCardRepository) {
        return args -> {
            ...
            Card spellCard = new SpellCard(4,"Hunter","Freezing Trap", "https://d15f34w2p8l1cc.cloudfront.net/hearthstone/640226c1384aea78225d5de3c1fcf3bf09d7004cd0ff66fbe8e818e89c9b34a0.png",2,Rarity.Common,"Core & Legacy","Secret: When an enemy minion attacks, return it to its owner's hand. It costs (2) more.","Frost");
